...
$(document).ready(function(){
	...
	$('#enter-site').click(function() {
		...
		setTimeout(function() {
			...
			$('#initial').show().css('display', 'inline-block');
		}, 1000);
	});

	// Quick test button functionality - skip loading immediately
	...
	$('#initial').click(function(){
		$(this).hide();
		setTimeout(function(){
			$('#turn_on').show().css('display', 'inline-block');
		}, 500);
	});
	...
	$('#play').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			$('#bannar_coming').show().addClass('show').fadeIn('slow');
		});
	});
	...
	$('#turn_on').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			$('#play').show().addClass('show').fadeIn('slow');
		});
	});
	...
	$('#bannar_coming').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			$('#balloons_flying').show().addClass('show').fadeIn('slow');
		});
	});
	...
	$('#balloons_flying').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			$('#invite_friends').show().addClass('show').fadeIn('slow');
		});
	});	
	...
	$('#invite_friends').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			$('#cake_fadein').show().addClass('show').fadeIn('slow');
		});
	});	
	...
	$('#cake_fadein').click(function(){
		...
		$(this).fadeOut('slow').delay(3000).promise().done(function(){
			$('#dj_time').show().addClass('show').fadeIn('slow');
		});
	});
	...
	$('#dj_time').click(function(){
		...
		$(this).fadeOut('slow').delay(3000).promise().done(function(){
			$('#story').show().addClass('show').fadeIn('slow');
		});
	});
  ...
  //       audio2.play();
		...
		$(this).fadeOut('slow').delay(3000).promise().done(function(){
			$('#picture_time').show().addClass('show').fadeIn('slow');
		});
	...
	$('#ai_assistant').click(function(){
		window.location.replace("src/html/ai.html")
	});
});
